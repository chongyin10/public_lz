...
log4js.configure({
    ...
    appenders: {
        ...
        // allLog: { type: 'dateFile', filename: './log/system_all', pattern: '-yyyy-MM-dd.log', alwaysIncludePattern: true },
        ...
        httpLog: { type: "dateFile", filename: "./log/system_httpAccess.log", pattern: ".yyyy-MM-dd", keepFileExt: true },

        //错误日志 type:过滤类型logLevelFilter,将过滤error日志写进指定文件
        errorLog: { type: 'file', filename: './log/system_error.log' },
